# Steps to Setup the Smart Mirror 🪜
...
### 4. Configure OS Settings (Optional but Recommended) ⚙️
 - Click the gear icon (settings) in the bottom right. This allows you to pre-configure system settings. It's helpful to enable SSH and set a username/password now, although for a smart mirror, the most critical step is setting the hostname and Wi-Fi.
 ...
 - Click SAVE.
### 5. Flash the SD Card  ⚡
- Click "CHOOSE STORAGE" and select your MicroSD card from the list. CAUTION: Double-check you select the correct drive, as this step will erase all data on it.
- Click "WRITE".
